package com.example.musicplayer;//package com.example.musicplayer;

import static android.content.Context.MODE_PRIVATE;
import static com.example.musicplayer.MainActivity.ARTIST_NAME_TO_FRAG;
...
public class NowPlayingFragmentBottom extends Fragment implements ServiceConnection {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                        ...
                        if(SHOW_MINI_PLAYER) {
                            if(PATH_TO_FRAG != null) {
                                ...
                                if(art != null) {
                                    ...
                                    Glide.with(getContext()).load(R.drawable.songs).into(albumArt);
                                }
        ...
        playPauseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(musicService != null) {
                    musicService.playPause_BtnClicked();
